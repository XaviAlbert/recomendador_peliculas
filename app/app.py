...
# PICTURES
ruta_1 = os.path.join('pictures', '1.jpg')
ruta_2 = os.path.join('pictures', '2.jpg')
ruta_3 = os.path.join('pictures', '3.png')
ruta_4 = os.path.join('pictures', '4.jpg')
ruta_5 = os.path.join('pictures', '5.jpg')
ruta_6 = os.path.join('pictures', '6.png')
ruta_7 = os.path.join('pictures', '7.jpg')
ruta_8 = os.path.join('pictures', '8.jpg')
...
def main():
    ...
    if question_6:
        ...
        - K-means:
          - Silhouette: 0.22978220006402528
        ''')
        st.image(ruta_6, width=600)

    if question_7:
        st.header('¿Qué variables tienen mayor impacto?')
        st.markdown('''
